...
{
    public class NoAuthAuthenticationHandler : AuthenticationHandler<NoAuthAuthenticationOptions>
    {
        ...
        public NoAuthAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            /*Your app redirects the user to https://app..com/-/oauth_authorize, passing parameters along as a standard query string:
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            ...
            var context = new NoAuthReturnEndpointContext(Context, ticket)
            {
